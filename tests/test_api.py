...
from src.aerolopa_crawler.api.validators import validate_iata_code, validate_aircraft_model
from src.aerolopa_crawler.api.utils import standardize_aircraft_model
from src.aerolopa_crawler.config import Config
from src.aerolopa_crawler.airlines import AirlineManager
...
class TestAPIValidation(unittest.TestCase):
    ...
    def test_standardize_aircraft_model(self):
        ...
        for input_model, expected in test_cases:
            ...
            self.assertEqual(result, expected, f"输入: {input_model}, 期望: {expected}, 实际: {result}")
...
class TestAPIEndpoints(unittest.TestCase):
    ...
    @patch('src.aerolopa_crawler.aerolopa_crawler.AerolopaCrawler.crawl_airline_seatmaps')
